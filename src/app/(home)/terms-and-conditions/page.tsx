    ...
    return (
        <div className="flex flex-col items-center justify-center bg-white p-8 font-sans text-black">
            <div className="max-w-[1100px]">
                ...
                <div className="mb-2 text-gray-600">Last Updated: 8/8/2024</div>
                <div className="mb-4">Welcome to the ConcertPal Chrome Extension ("the Extension") and website ("the Website"). By accessing or using the Extension, you agree to be bound by these Terms and Conditions. Please read them carefully.</div>

                <h2 className="mb-2 text-2xl font-semibold">1. Acceptance of Terms</h2>
                <div className="mb-4">By using the Extension, you agree to comply with and be bound by these Terms. If you do not agree to these Terms, you must not use the Extension.</div>

                <h2 className="mb-2 text-2xl font-semibold">2. Description of the Extension</h2>
                <div className="mb-4">The Extension uses various ticket retailers’ APIs to find information on concerts and ticket pricing for the user.</div>

                <h2 className="mb-2 text-2xl font-semibold">3. Changes to Terms</h2>
                <div className="mb-4">We reserve the right to modify these Terms at any time. Any changes will be posted on this page and will take effect immediately upon posting. Your continued use of the Extension or the Website after any changes indicates your acceptance of the new Terms.</div>
                ...
                <div className="mb-4">We are not responsible for any issues arising from the use of TicketMaster’s services, including but not limited to data accuracy, availability, and any changes to TicketMaster’s API.</div>
                ...
                <div className="mb-4">We are not responsible for any issues arising from the use of SeatGeek’s services, including but not limited to data accuracy, availability, and any changes to SeatGeek’s API.</div>
                ...
                <div className="mb-4">We are not responsible for any issues arising from the use of VividSeats’ services, including but not limited to data accuracy, availability, and any changes to VividSeats’ API.</div>
                ...
                <div className="mb-4">We are not responsible for any issues arising from the use of StubHub’s services, including but not limited to data accuracy, availability, and any changes to StubHub’s API.</div>

                <h2 className="mb-2 text-2xl font-semibold">9. Ticket Purchases</h2>
                <div className="mb-4">The Extension provides links to third-party ticket vendors. We do not sell tickets directly and are not responsible for any issues related to ticket purchases, including but not limited to pricing, availability, and the fulfillment of ticket purchases. All ticket purchases are subject to the terms and conditions of the respective third-party vendor.</div>
                ...
                <div className="mb-4">All content and materials available through the Extension, including but not limited to text, graphics, logos, and software, are the property of ConcertCal LLC or its licensors and are protected by intellectual property laws.</div>

                <h2 className="mb-2 text-2xl font-semibold">12. Termination</h2>
                <div className="mb-4">We reserve the right to terminate or suspend your access to the Extension at our sole discretion, without prior notice, for conduct that we believe violates these Terms or is harmful to other users or our business interests.</div>

                <h2 className="mb-2 text-2xl font-semibold">13. Disclaimer of Warranties</h2>
                <div className="mb-4">The Extension is provided " as is " and " as available " without warranties of any kind, either express or implied, including but not limited to implied warranties of merchantability, fitness for a particular purpose, and non-infringement.</div>
                ...
                <div className="mb-4">These Terms shall be governed by and construed in accordance with the laws of the relevant jurisdiction, without regard to its conflict of law principles.</div>
