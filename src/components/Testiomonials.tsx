            ...
            >
                {testimonials.map((testimonial, index) => (
                    <SwiperSlide key={index} className="px-4 mb-16">
                        <div className="bg-white   min-h-[300px] shadow-lg hover:shadow-xl transition-all transform hover:scale-105 p-4 sm:p-6 md:p-8 rounded-xl text-center border border-gray-200">
                            ...
                            <div className="flex justify-center mb-4">
                                <img className="h-10 w-10 rounded-full" src={testimonial.image}></img>
                            </div>
                            <p className="text-xs sm:text-base md:text-lg leading-snug tracking-tight text-gray-700 mb-3">{`“${testimonial.quote}”`}</p>
