                        ...
                        <div className="flex transition-transform ease-out duration-500" style={{ transform: `translateX(-${activeSlide * 100}%)` }}>
                            ...
                            <div className="flex-shrink-0 w-full" style={getSlideStyle(0)}>
                                ...
                                <div className="relative">
                                    ...
                                    <iframe className="xs:w-[360px] h-[400px] w-full md:aspect-[16/9] flex justify-center items-center mx-auto pointer-events-none" src="https://www.youtube.com/embed/4oSLhUGGMwA?autoplay=1&controls=0&loop=1&playlist=4oSLhUGGMwA&mute=1" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                                </div>
                            </div>
                            {/* Item 2 */}
                            <div className="flex-shrink-0 w-full" style={getSlideStyle(1)}>
                                ...
                                <div className="relative">
                                    <div className="absolute inset-0 z-10" />
                                    <iframe className="xs:w-[360px] h-[400px] w-full md:aspect-[16/9] flex justify-center items-center mx-auto pointer-events-none" src="https://www.youtube.com/embed/bhwbvFj46bM?autoplay=1&controls=0&loop=1&playlist=bhwbvFj46bM&mute=1" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerPolicy="strict-origin-when-cross-origin" allowFullScreen></iframe>
                                </div>
                            </div>
                        </div>
                    </div>
