      ...
      <div className="w-[280px] p-4 bg-white flex justify-start items-start gap-4 rounded-lg cursor-pointer">
        ...
        <div className="flex flex-col items-start gap-1">
          <span className="flex justify-center items-center gap-2">
            ...
            <p className="max-w-[150px] font-semibold tracking-tight text-gray-900 trun">
              {artistName}
            </p>
          </span>
          ...
          <span className="flex justify-center items-center gap-2">
            ...
            <p className="max-w-[150px] text-gray-600 text-sm font-medium tracking-tight truncate">
              {venue}
            </p>
          </span>
