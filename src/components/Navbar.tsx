      ...
      <div className="flex relative p-4 justify-between items-center md:max-w-[1440px] md:m-auto">
        ...
        <span className="flex justify-center items-center gap-4">
          <motion.div whileHover={{ scale: 1.1 }} className="hidden lg:flex gap-7 items-center">
            <Link
              href={
                "https://chromewebstore.google.com/detail/concertpal/nnbeepdmhiimdmeifpkbeinmbafaedja"
              }
              target="_blank"
              className=" rounded-xl bg-primary text-white px-6 py-2 flex items-center gap-2"
            >
              Install
            </Link>
          </motion.div>
        ...
        <div
          className={`fixed lg:hidden bg-white w-full h-screen left-0 right-0 ease-in-out duration-300 ${openNavbar ? "top-0" : "-top-[3000px]"}`}
        >
          ...
          <ul className="flex flex-col  gap-8 p-4 font-bold mt-12 justify-between">
            ...
            <Link
              ...
              target="_blank"
              className=" text-center justify-center  rounded-full bg-primary text-white px-6 py-2 flex items-center gap-2"
            >
